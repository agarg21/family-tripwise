...
| Template | Search intent | Monetization | Tool angle |
|---|---|---|---|
...
Each destination cluster should link:

- Activities page to itinerary page.
- Where-to-stay page to hotel page.
- Hotel page back to where-to-stay page.
