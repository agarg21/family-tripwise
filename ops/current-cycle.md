...
- Latest GSC evidence: `ops/gsc-snapshots/2026-08-17.md`, fresh authenticated read-only API evidence with finalized data through 2026-08-15. The property has 1,897 impressions, 6 clicks, aggregate average position 64.01, 28 discovered pages, and 24 of 28 inspected URLs indexed. The rolling increase, unchanged clicks/indexing, page-average positions and absence of a public query cohort do not create a CTR or rewrite action.
...
- GSC: authenticated read-only API collection is working; the August 17 snapshot has finalized data through August 15, 1,897 impressions and 6 clicks over 28 days, a successful sitemap read with 28 discovered pages, and 24 of 28 monitored URLs indexed
...
- Current authenticated API evidence is in `ops/gsc-snapshots/2026-08-17.json`, collected through the read-only API with finalized data through August 15; it supersedes earlier UI and API snapshots for current status.
...
- Latest public preflight on August 16: sitemap returned 200 with 28 parsed URLs; robots returned 200 and advertises the sitemap; all 28 configured URLs returned 200 and appeared in the sitemap.
- Current normalized source: `ops/gsc-snapshots/2026-08-17.json`, collected through the authenticated read-only API on August 17 with finalized data through August 15.
