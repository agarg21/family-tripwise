...
- Latest GSC evidence: `ops/gsc-snapshots/2026-08-23.md`, fresh authenticated read-only API evidence with finalized data through 2026-08-21. The property has 2,105 impressions, 5 clicks, aggregate average position 65.72, 28 discovered pages, and 24 of 28 inspected URLs indexed. The San Diego family-hotel row remains at 925 impressions and page-average position 72.37. The rolling page/property averages and absence of a public query cohort do not create a CTR or rewrite action.
...
- GSC: authenticated read-only API collection is working; the August 22 snapshot has finalized data through August 20, 2,194 impressions and 5 clicks over 28 days, a successful sitemap read with 28 discovered pages, and 24 of 28 monitored URLs indexed
- Current site source: `site/`
- Main generators/scripts: `tools/generate-pages.mjs`, `tools/upgrade-priority-pages.mjs`
- Current released implementation: `FT-MAINT-003` at commit `20f88bd6ec995f05beb4e430936fbb1bb5f7a522`; Pages run `32120676612`, release marker, target invariants and production SEO verification pass
...
- Current authenticated API evidence is in `ops/gsc-snapshots/2026-08-22.json`, collected through the read-only API with finalized data through August 20; it supersedes earlier UI and API snapshots for current status.
