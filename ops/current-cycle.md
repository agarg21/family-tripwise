...
- Latest GSC evidence: `ops/gsc-snapshots/2026-08-21.md`, fresh authenticated read-only API evidence with finalized data through 2026-08-19. The property has 2,085 impressions, 5 clicks, aggregate average position 65.52, 28 discovered pages, and 24 of 28 inspected URLs indexed. Inspection/crawl state is unchanged; the rolling page/property averages and absence of a public query cohort do not create a CTR or rewrite action.
...
- GSC: authenticated read-only API collection is working; the August 21 snapshot has finalized data through August 19, 2,085 impressions and 5 clicks over 28 days, a successful sitemap read with 28 discovered pages, and 24 of 28 monitored URLs indexed
...
- Current authenticated API evidence is in `ops/gsc-snapshots/2026-08-21.json`, collected through the read-only API with finalized data through August 19; it supersedes earlier UI and API snapshots for current status.
...
- Current normalized source: `ops/gsc-snapshots/2026-08-21.json`, collected through the authenticated read-only API on August 21 with finalized data through August 19.
