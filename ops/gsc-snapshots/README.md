...
Complete page-query exports use the protected path documented in `docs/plan/protected-gsc-query-export.md`; they must remain encrypted in GitHub artifacts and may be decrypted only into `~/.codex/private/family-tripwise/protected-gsc-query-exports/` outside this public repository.
