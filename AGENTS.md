...
- Default the first daily run to learning and the second to applying, deepening, or independently validating that learning. A supported `PRESERVE` decision or rejected hypothesis counts; page edits are never required merely to satisfy the daily unit.
