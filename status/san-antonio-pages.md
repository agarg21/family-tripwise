...
|---|---|---|---|---|---|---|---|---|---|
| Main things-to-do hub | https://familytripwise.com/things-to-do/san-antonio-with-kids.html | Exact measured phrases: 5,400, 1,600, and 880/month; variants overlap | Avg position 64.36; 11 impressions | Top 20 first, then Top 10 | `things to do in san antonio with kids`; `things to do with kids in san antonio`; `san antonio things to do with kids` | Canonical/indexable existing page; no observation protection. | `FT-RES-010` reviews both core SERPs, representative ranking pages, `SA-P1` through `SA-P5`, and every visible section. Verdict: highest-value improvement; six choices are repeated across too many layers. | Needs a fresh 18+ candidate review, direct official sources, calibrated comparison fields, responsive QA, and independent review. | `FT-IMP-018` / `IMP-036` is the one promoted action; ready but not started by this research transaction. |
...
1. Ready: `FT-IMP-018` improves the existing all-ages things-to-do hub.
...
No San Antonio page is protected by an active observation window. Early GSC evidence is too sparse for causal evaluation, so useful separately authorized improvements need not wait for an artificial hold. This research transaction itself makes no site change and does not start `FT-IMP-018`.
