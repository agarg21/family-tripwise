...
|---|---|---:|---|---|---|---|---|---|---|
| Main things-to-do hub | https://familytripwise.com/things-to-do/new-york-city-with-kids.html | Exact measured phrases: 480, 390, and 320/month; variants overlap | Avg position 43.98; 55 impressions | Top 20 first, then Top 10 | `things to do in New York City with kids`; `things to do with kids in New York City`; `fun things to do in New York City with kids` | Indexed; promoted as the first NYC improvement under `FT-IMP-014`, not yet selected. | Cluster, current competition, NYC-P1 through NYC-P5, and every visible section reviewed under review-clean `FT-RES-009`. | Needs a page-specific candidate/source review and implementation. Current page repeats six choices across several sections. | Select and implement `FT-IMP-014` / `IMP-031`. |
