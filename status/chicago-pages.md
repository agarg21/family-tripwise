...
|---|---|---:|---|---|---|---|---|---|---|
| Main things-to-do hub | https://familytripwise.com/things-to-do/chicago-with-kids.html | 5,400 core exact; many overlapping broad variants | Avg position 58.88; 52 impressions | Top 20 first, then Top 10 | `things to do in Chicago with kids`; `Chicago with kids`; `best things to do in Chicago with kids` | Live, indexed, useful but repetitive and narrow. | Cluster, competition, five personas, and every visible section reviewed under `FT-RES-008`. | Six choices are repeated across cards, situation picks, table, details, and mini-itineraries; sources are generic. | `FT-IMP-010` / `IMP-025`: wider candidate review and compact hub improvement. |
...
1. Improve the all-ages things-to-do hub under `FT-IMP-010`.
