...
- Current public-safe GSC snapshot: `ops/gsc-snapshots/2026-08-14.md`
...
## August 14 Family-Hotel Crawl Overlay

Fresh authenticated read-only GSC evidence collected August 14 is finalized through August 12. The family-hotel page remains submitted and indexed, and URL Inspection now records a successful crawl at 2026-08-13 16:43 UTC instead of the prior July 28 crawl. Its public 28-day row has 588 impressions, zero clicks, and page-average position 70.17.

This creates a clean new measurement boundary, not a ranking verdict: the finalized performance window ends one day before the crawl, so it contains zero post-crawl days. Keep the page unchanged and wait until a later protected export contains sufficient finalized post-August 13 query evidence before interpreting query ownership or movement. The stay-area page remains indexed with its July 31 crawl.
...
`FT-IMP-005` is released and production-verified at `31bba30` through Pages run `29876597948`. `FT-EVAL-001` remains superseded. `FT-AUTH-005` / `IMP-042` is released and production-verified at `e7c40ff` through Pages run `30667262994`. `FT-EVAL-002` supplies the public-safe area-versus-hotel baseline. `FT-IMP-022` is released and production-verified at `e5e41ec` through run `30930924523`; it changes only the areas page and leaves the hotel page unchanged. The family-hotel page was crawled August 13; wait for sufficient finalized post-crawl evidence. Do not infer a July rewrite result, merge the URLs, or manufacture another action from cadence.
