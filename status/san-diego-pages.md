...
- Latest public-safe GSC snapshot: `ops/gsc-snapshots/2026-07-21.md`
...
|---|---|---:|---|---|---|---|---|---|---|
| Main things-to-do hub | https://familytripwise.com/things-to-do/san-diego-with-kids.html | 4.4K+ known core demand | UNKNOWN: latest inspection said URL unknown; no page-row position | Top 20 first, then Top 10 | `things to do in San Diego with kids`; `best things to do in San Diego with kids`; `San Diego with kids activities` | Live; the 12-activity `FT-IMP-005` revision is review-clean and eligible for release. | Keeps the persona router and compares 12 primary activities. Six new major/day-trip choices receive compact logistics notes without repeating every existing attraction in another long layer. | Needs release, then Google crawl/indexing and performance observation. | Complete the exact-scope release gate; observe only after the revised page is live. |
...
| Family hotel shortlist | https://familytripwise.com/where-to-stay/san-diego-family-hotels.html | 2.7K+ known hotel/resort/amenity demand | UNKNOWN: page newer than GSC performance window | Top 20 first, then Top 10 | `family friendly hotels in San Diego`; `best family hotels in San Diego`; `San Diego family resorts` | Live; the 12-hotel `FT-IMP-005` revision is review-clean and eligible for release. | Keeps the original eight and adds La Jolla Shores Hotel, Hotel del Coronado, The Dana on Mission Bay, and Manchester Grand Hyatt for four concrete trip-style gaps. All 12 retain rough ranges, direct map links, official setup facts, current checks, and directional online-review themes. | Needs release, crawl/indexing, and early query evidence. The shared My Map has not been externally updated with the four additions. | Complete the exact-scope release gate, then use non-blocking `FT-EVAL-002` only after current evidence exists. |
