...
- Current public-safe GSC snapshot: `ops/gsc-snapshots/2026-08-21.md`
...
| Family hotel shortlist | https://familytripwise.com/where-to-stay/san-diego-family-hotels.html | 2.7K+ known hotel/resort/amenity demand | Avg position 72.24; 854 impressions; 0 clicks | Top 20 first, then Top 10 | `family friendly hotels in San Diego`; `best family hotels in San Diego`; `San Diego family resorts` | Live, indexed, and successfully recrawled August 13; `FT-MAINT-003` is released and production-verified at `20f88bd6ec995f05beb4e430936fbb1bb5f7a522` through Pages run `32120676612` after Bacon `PASS`. | Keeps the original eight and four trip-style additions. All 12 official records are refreshed; La Jolla Shores and Loews conflicts are explicit; older July price orientation remains clearly dated. | The performance window has only six complete finalized post-crawl days, so there is no ranking or CTR conclusion. | Preserve the 12-hotel role and August 13 GSC boundary; wait for sufficient finalized query evidence before a performance action. |
