...
- Current public-safe GSC snapshot: `ops/gsc-snapshots/2026-08-17.md`
...
Note: The implementation baseline remains the July 21 snapshot. The family-hotel row uses the August 17 snapshot finalized through August 15; the stay-area row uses August 4, and unrelated page rows retain their prior recorded baseline. None of these windows can establish causal impact from a page change. Demand estimates are directional monthly US search demand from historical Semrush/research notes, not fresh keyword-tool pulls. Top queries are target/query-universe examples, not protected GSC query exports; complete protected rows remain outside this public repository.

## August 17 Family-Hotel Crawl Overlay

Fresh authenticated read-only GSC evidence collected August 17 is finalized through August 15. The family-hotel page remains submitted and indexed, and URL Inspection still records the successful crawl at 2026-08-13 16:43 UTC instead of the prior July 28 crawl. Its public 28-day row has 676 impressions, zero clicks, and page-average position 70.33.

This remains a measurement boundary, not a ranking verdict: the finalized performance window contains only two complete calendar days after the crawl and the public snapshot has no query cohort. Do not make ranking-driven edits until a later protected export contains sufficient finalized post-August 13 query evidence; the separately authorized factual maintenance remains allowed because it corrects source freshness rather than interpreting performance. The stay-area page remains indexed with its July 31 crawl.
...
| Stay areas / where to stay | https://familytripwise.com/where-to-stay/san-diego-with-kids.html | 360+ known stay-area demand; overlaps hotel demand | Avg position 62.04; 426 impressions; 1 click | Top 20 | `where to stay in San Diego with kids`; `best area to stay in San Diego with kids`; `where should families stay in San Diego` | Live, indexed, released, and production-verified through `FT-IMP-022` at `e5e41ec` / run `30930924523` after Lovelace cycle-two `PASS`. | The title, H1, description, hero, ItemList name, booking heading, and named-hotel handoff now define one five-area decision. The five choices, comparison, constraint tool, and four property checks remain. | The short post-crawl tail prevents a causal ranking verdict; no release blocker remains. | Wait for a later crawl and sufficient finalized post-crawl query evidence before interpreting query ownership or ranking movement. |
| Family hotel shortlist | https://familytripwise.com/where-to-stay/san-diego-family-hotels.html | 2.7K+ known hotel/resort/amenity demand | Avg position 70.33; 676 impressions; 0 clicks | Top 20 first, then Top 10 | `family friendly hotels in San Diego`; `best family hotels in San Diego`; `San Diego family resorts` | Live, indexed, and successfully recrawled August 13; `FT-MAINT-003` is released and production-verified at `20f88bd6ec995f05beb4e430936fbb1bb5f7a522` through Pages run `32120676612` after Bacon `PASS`. | Keeps the original eight and four trip-style additions. All 12 official records are refreshed; La Jolla Shores and Loews conflicts are explicit; older July price orientation remains clearly dated. | The performance window has only two complete finalized post-crawl days, so there is no ranking or CTR conclusion. | Preserve the 12-hotel role and August 13 GSC boundary; wait for sufficient finalized query evidence before a performance action. |
...
| Family hotel shortlist | P1, P4 mapped | Detailed competitor/OTA/forum review plus current official-source refresh complete 2026-08-17 | Complete; 12-hotel expansion plus maintenance review pending | Keep the 12 because each serves a distinct trip shape; retain current room, fee, parking, pool, shuttle and renovation checks without adding prose or hotels. |
