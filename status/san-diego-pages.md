...
- Current public-safe GSC snapshot: `ops/gsc-snapshots/2026-08-16.md`
...
## August 16 Family-Hotel Crawl Overlay

Fresh authenticated read-only GSC evidence collected August 16 is finalized through August 14. The family-hotel page remains submitted and indexed, and URL Inspection still records the successful crawl at 2026-08-13 16:43 UTC instead of the prior July 28 crawl. Its public 28-day row has 661 impressions, zero clicks, and page-average position 70.25.

This remains a measurement boundary, not a ranking verdict: the finalized performance window contains only one complete calendar day after the crawl and the public snapshot has no query cohort. Keep the page unchanged and wait until a later protected export contains sufficient finalized post-August 13 query evidence before interpreting query ownership or movement. The stay-area page remains indexed with its July 31 crawl.
...
One material source update is actionable: La Jolla Shores now officially describes a newly refreshed heated pool and children's wading pool, while its current first-party pages disagree between $45 and $55 parking. The original eight records checked July 18 also reach their explicit August 17 official-fact boundary; the four July 21 records remain inside 30 days, while every visible price observation is beyond 14 days. `FT-MAINT-003` / `IMP-043` is promoted as one later factual/evidence refresh of the existing 12-hotel page and remains unselected. That maintenance is allowed during observation because it fixes source freshness; it must preserve August 13 as the GSC performance boundary and cannot be treated as a ranking test.
...
| Family hotel shortlist | https://familytripwise.com/where-to-stay/san-diego-family-hotels.html | 2.7K+ known hotel/resort/amenity demand | Avg position 74.11; 175 impressions; 0 clicks | Top 20 first, then Top 10 | `family friendly hotels in San Diego`; `best family hotels in San Diego`; `San Diego family resorts` | Live, indexed, and successfully recrawled August 13; the 12-hotel `FT-IMP-005` revision is released and production-verified at `31bba30` through Pages run `29876597948`. `FT-RES-016` completed a 12-record freshness audit August 17 without changing the page. | Keeps the original eight and four trip-style additions. Current official sources still support the core set and decision facts. | The performance window has only one complete finalized post-crawl day. Separately, the original eight official records reach their August 17 boundary, every visible July price observation exceeds 14 days, and La Jolla Shores has a refreshed official pool state plus a first-party parking conflict. | `FT-MAINT-003` / `IMP-043` is the next evidence-eligible factual refresh, not yet selected. Preserve the 12-hotel role and August 13 GSC boundary. |
