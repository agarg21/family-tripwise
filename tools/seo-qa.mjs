...
for (const filePath of htmlFiles) {
  ...
  for (const notice of findYearlessOperationalNotices(html)) {
    warnings.push(`${rel} needs operational date review (year missing; expiry UNKNOWN) for ${notice.dateText}: ${notice.excerpt}`);
  }
