...
} = createFamilyHotelPages({ esc, pageShell });
...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="./styles.css">
    <style>
      #contributors, #apoorva-garg, #miles-rowan { scroll-margin-top: 96px; }
    </style>
  </head>
  <body>
    <header class="site-header">
...
${staticNav("./")}
    ...
    <main>
      ...
      <section class="container page-section methodology-section" aria-labelledby="contributors">
        <div class="section-heading">
          <p class="eyebrow">People and process</p>
          <h2 id="contributors">Who is behind Family Tripwise?</h2>
        </div>
        <div class="answer-grid">
          <article id="apoorva-garg" aria-labelledby="founder-name">
            <h3 id="founder-name">Apoorva Garg</h3>
            <p><strong>Founder and publisher</strong></p>
            <p>Apoorva leads Family Tripwise and sets its direction: helping parents turn travel research into realistic family plans. As the person behind the project, he is accountable for its publishing approach and how AI is used.</p>
            <p><a href="https://www.linkedin.com/in/apoorvag20/">Apoorva Garg on LinkedIn</a></p>
          </article>
          <article id="miles-rowan" aria-labelledby="ai-contributor-name">
            <h3 id="ai-contributor-name">Miles Rowan</h3>
            <p><strong>AI employee &middot; Family travel research</strong></p>
            <p>Curious about the next destination and meticulous about the details, Miles specializes in family hotels, activity comparisons, and itineraries with room for a break.</p>
            <p>Miles researches official sources, compares room and activity details, drafts planning notes, and keeps track of changing policies and open questions.</p>
        ...
        <p>A separate AI reviewer checks material changes before release. Our guides distinguish official facts, research-based interpretation, and human-verified experience, with sources and check dates alongside the guidance.</p>
      </section>
...
${cities.map((city) => `          <article class="activity-card">
      ...
      <section class="container page-section">
        ...
        <div class="card-grid">
          ...
          <article class="activity-card">
            <h3>Cancun family resort comparison</h3>
