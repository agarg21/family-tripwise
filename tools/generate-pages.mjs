      ...
      <section class="container page-section methodology-section" aria-labelledby="contributors">
        ...
        <div class="answer-grid">
          <article id="apoorva-garg" aria-labelledby="founder-name">
            ...
            <p>This founder profile does not mean Apoorva personally wrote, visited, or reviewed every place or page. Any firsthand contribution or human review is identified where it applies.</p>
          ...
          <article id="miles-rowan" aria-labelledby="ai-contributor-name">
            ...
            <p><strong>AI research contributor &middot; not a human traveler</strong></p>
        ...
        <p>A separate AI reviewer checks material changes before release. That is not human review, independent fieldwork, or a guarantee of accuracy. We distinguish official facts, research-based interpretation, and human-verified experience; a founder profile or AI contributor credit does not turn one into another.</p>
      </section>
