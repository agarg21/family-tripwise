...
<head>
  ...
  <meta name="description" content="Compare three Cancun-area all-inclusive family resorts by exact room category, child club ages, airport-transfer terms and unresolved costs. Source-linked policy checks.">
...
<body class="cancun-page">
  ...
  <main id="main">
    <section class="page-intro">
      ...
      <p>Three all-inclusive resorts, compared by the room and policy details that can change a family booking. This is a focused planning comparison, not a ranking of every resort.</p>
      <p><strong>For five people:</strong> Finest publishes a five-person Family Suite with a separate children's room. Dreams Sapphire publishes a six-person family category, but the sleeping layout needs confirmation. Sunscape's two official capacity listings disagree. None is a confirmed booking for your dates.</p>
    ...
    <section id="family-check" aria-labelledby="family-title">
      ...
      <p>Two adults and one to five children, ages 0-17 at travel. A room maximum, a club-age match and a transfer offer are separate checks. All three resorts stay visible, including conflicts and unknowns.</p>
    ...
    <section id="before-booking">
      ...
      <ol>
        ...
        <li><strong>Complete quote:</strong> request the room total for your party, taxes, mandatory fees, delivery charges, transfers and any paid childcare. Confirm cancellation terms for the actual rate. We have not observed a comparable, date-specific three-resort quote.</li>
    ...
    <section class="geography">
      ...
      <p>Sunscape is in Cancun's Hotel Zone; Finest is in Playa Mujeres to the north; Dreams Sapphire is in Riviera Cancun. The map links above locate each named resort. No transfer time, beach condition, safe swimming or stroller-route guarantee is implied.</p>
      <figure><img src="https://thumb.wikimedia.org/wikipedia/commons/thumb/9/9a/Canc%C3%BAn_aerial_2024.jpg/1280px-Canc%C3%BAn_aerial_2024.jpg" width="1280" height="960" alt="Aerial view of Cancun's coast and lagoon in January 2024, for geographic context." loading="lazy" decoding="async"><figcaption>Cancun area, January 2024; not a photo of the three compared rooms. Antony-22, <a href="https://commons.wikimedia.org/wiki/File:Canc%C3%BAn_aerial_2024.jpg">Wikimedia Commons</a>, <a href="https://creativecommons.org/licenses/by-sa/4.0/">CC BY-SA 4.0</a>. Uncropped, displayed smaller.</figcaption></figure>
    </section>
    <section id="methodology">
      <h2>What this comparison can establish</h2>
      <p>The same dated official-property records supply the comparison and the age checks. The three resorts were chosen to expose different room, age and transfer constraints, not as a statistically representative sample or a best-value shortlist. Where two official pages conflict, both remain linked.</p>
