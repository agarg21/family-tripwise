...
const activityPages = {
  "things-to-do/san-diego-with-kids.html": {
    ...
    rows: [
      ...
      ["The New Children's Museum", "1-9", "2-3 hrs", "$$", "Downtown", "Easy", "Yes", "High", "Check current calendar", "Hands-on younger-child Downtown anchor", "Waterfront Park or early meal"],
