...
export const cancunEvidence = {
  ...
  recheckOn: "2026-10-22",
  publicationStatus: "prototype-not-published",
  sources: {
  ...
  records: [
    {
      ...
      clubs: {
        ...
        checks: ["Teen lounge is mentioned without an exact age band; do not infer admission for age12.", "Imagine Lounge is separate mealtime care: toilet-trained ages3+, registration, maximum90minutes. Its rules are not generalized to Mini/Maxi Club.", "Actual admission, capacity and current programme must be confirmed; absence of a recorded condition is not a waiver."]
      },
    ...
    },
    {
      ...
      clubs: {
        ...
        checks: ["Age3 is below the published Explorer's Club band, not proof that all resort activities exclude three-year-olds. Confirm admission conditions and actual operations."]
      },
      ...
      extras: { sourceIds: ["S4"], checks: ["The FAQ lists an environmental tax of MXN79 per room/night and room-service delivery charges despite general inclusion language; verify dated fee applicability. Nanny services are extra."] }
    },
    {
